...
class Replay(AutonomousStateMachine):
    ...
    def run(self):
        ...
        self.drive.move(x=-self.recording['frames'][self.frame]['joysticks'][0]['axes'][1] * self.compensation,
                        y=self.recording['frames'][self.frame]['joysticks'][0]['axes'][0] * self.compensation,
                        rot=self.recording['frames'][self.frame]['joysticks'][1]['axes'][0] * self.compensation)
        """
